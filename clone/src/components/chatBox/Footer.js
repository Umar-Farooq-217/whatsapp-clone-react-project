...
<input type="text" placeholder='Ty(pe a message' className='text-[20px] border border-gray-200 py-[5px] rounded-md flex-1 mx-5 pl-6 outline-none' onKeyDown={(e)=>sendText(e)} onChange={(e)=>setValue(e.target.value)} />
