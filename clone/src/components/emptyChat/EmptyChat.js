...
export default function EmptyChat() {
  return (
    <Box className='border-l border-gray-200' sx={{width:'100%',height:'100%', backgroundColor:'#F8FAF8',overflowY:'hidden'}} >
   <img src={emptyChatImage} alt="EmptyChatImage" className='max-w-full w-[400px] flex m-auto pt-36 ' />
